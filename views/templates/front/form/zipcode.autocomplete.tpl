...
<form autocomplete="off" action="#" class="autocomplete-form">
  <div class="autocomplete">
        ...
        <input class="btn btn-primary" id="dealt-offer-submit" type="button" onclick="actionAjaxAddOffer(this)"
               value="{l s='Add service' d='Modules.Dealtmodule.Shop'}" data-dealt-offer-id={$offer.dealtOfferId} data-dealt-offer-uuid="{$offer.dealtOfferUUIDV4}"
...
<script>
    autocomplete(document.getElementById("dealt-zipcode-autocomplete"), source);
</script>